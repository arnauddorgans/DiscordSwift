...
public protocol GuildService {
  ...
  /// - seealso: https://discord.com/developers/docs/resources/guild#get-guild
  ...
  /// - seealso: https://discord.com/developers/docs/resources/guild#get-guild-preview
  func getGuildPreview(id: Snowflake) async throws -> Guild.Preview
  
  /// Returns a list of guild channel objects. Does not include threads.
  /// - seealso: https://discord.com/developers/docs/resources/guild#get-guild-channels
